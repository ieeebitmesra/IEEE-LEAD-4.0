...
const Skills = () => {
  return <div className='section my-8' id='skills'>
    <div className='container mx-auto'>
      <div className='flex flex-col lg:flex-row gap-x-10 lg:justify-between'>
        <div className='mb-4'>
          <h2 className='h2 leading-tight text-accent'>Skills</h2>
          <p className='max-w-md mb-4'>I've worked with a variety of languages, frameworks and libraries, and have a keen interest in learning more about them.</p>
        </div>
        <div className='flex-1 max-w-lg flex flex-col gap-y-10'>
          <div className='flex flex-col justify-center items-center gap-y-2'>
            <div className=' grid grid-cols-2 sm:grid-cols-3 gap-x-4 gap-y-2'>
              ...
              <motion.div
                ...
                whileInView={'show'}
                viewport={{once:false, amount:0.3}} 
                className='hidden sm:block sm:col-start-2'
              >
                <div class="card">
                  <div class="icon">
